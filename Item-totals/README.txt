'RealWorld-Excel-Item-Totals' is a computer program which does the following:

Extract, for Excel spreadsheet work, some information from a RealWorld report
(the Input) entitled,

'Fast analysis - customers for an item'.

RealWorld should be asked to make its HTML version of this report.

The Input report is run for a single period of time.

The Input report should be run without (printing) a cover page.
